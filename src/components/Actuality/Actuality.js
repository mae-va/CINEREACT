                ...
                <div className="container-overlay pl-0"></div>
                    <div className="container-fluid bloc_actuality pl-0 pr-0">
                        <div class="row actuality">
                            <div className="col-lg-7 col-md-12 pl-0 pr-0 poster_column">
                                ...
                                <div className="col-lg-5 col-md-12 black">
                                    <div className="row mb-3 pl-5 title">INTERSTELLAR</div>
                                    ...
                                    <div className="row synopsis pb-4 pl-5 pr-5 mr-5mb-5 d-none d-lg-block">
                                        ...
                                        <button className="readMore ml-5">+</button>
                                    </div>
